...
class miniColumn():
    ...
    def __init__(self, input_dim = (32,32), potential_percent = 0.5, perm_decrement = 0.008, perm_increment = 0.05, perm_thresh = 0.1, duty_cycle_period = 1000):
        #Constructor method.
...
class SpatialPooler():
    ...
    def __init__(self, input_dim = (32,32), column_num = 2000, potential_percent = 0.85, active_cols = 40, stimulus_thresh = 0, perm_decrement = 0.005, perm_increment = 0.04, perm_thresh = 0.1, min_duty_cycle = 0.001, duty_cycle_period = 100, boost_str = 3):
        #Constructor method.
        #input_dim -> Expected dimensions of the input space.
        ...
        self.boost_factors = np.ones((column_num,1))
    ...
    def compute_overlap(self, arr):
        ...
        overlap_scores = np.zeros((self.column_num,1))
    ...
    def get_active_columns(self, overlaps, plot = False):
        ...
        active_columns = np.zeros((self.column_num,1))
...
class AnomalyTracker():
    ...
    def process_input(self, pred, active):
        ...
        if self.input_counter % self.estimation_samples == 0 and self.include_likelihoods:
